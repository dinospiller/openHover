...
void commands_process_packet(unsigned char *data, unsigned int len) {
	...
	SELF_BALANCING_PARAMS sb_params;
	uint16_t flash_res;
	uint32_t new_app_offset;
	chuck_data chuck_d_tmp;
	REF_SEQUENCE* seq_dot_Xb;
	REF_SEQUENCE* seq_dot_delta;
	...
	case COMM_GET_TACHO:
		ind = 0;
		send_buffer[ind++] = COMM_GET_TACHO;
		buffer_append_int32(send_buffer, mc_interface_get_tachometer_value(false), &ind);
		commands_send_packet(send_buffer, ind);
		break;

	case COMM_RESET_TACHO:
		ind = 0;
		send_buffer[ind++] = COMM_RESET_TACHO;
		buffer_append_int32(send_buffer, mc_interface_get_tachometer_value(true), &ind);
		commands_send_packet(send_buffer, ind);
		break;
	...
	case COMM_GET_SELF_BALANCE_PAR:
		sb_params = *self_balancing_get_params();
		ind = 0;
		send_buffer[ind++] = COMM_GET_SELF_BALANCE_PAR;
		send_buffer[ind++] = sb_params.loop_period_ms;
		send_buffer[ind++] = sb_params.n_poles;
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.kt,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.r_wheel,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.rho,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.d_interwheel,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gainsLQR[0],&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gainsLQR[1],&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gainsLQR[2],&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gainsLQR[3],&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.dot_Xb_filt.N0,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.dot_Xb_filt.N1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.dot_Xb_filt.N2,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.dot_Xb_filt.D1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.dot_Xb_filt.D2,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.set_Xb_filt.N0,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.set_Xb_filt.N1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.set_Xb_filt.D1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.steering_PID.N0,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.steering_PID.N1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.steering_PID.D1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.accelero_filter.N0,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.accelero_filter.N1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.accelero_filter.N2,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.accelero_filter.D1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.accelero_filter.D2,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.compl_filt_alpha,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.compl_filt_beta,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gainsLQRsteering[0],&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gainsLQRsteering[1],&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.imu_accx_offset,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.imu_accz_offset,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.imu_gyro_offset,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.disturbance_torque_ampl,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.disturbance_torque_omega,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gyro_filter.N0,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gyro_filter.N1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gyro_filter.N2,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gyro_filter.D1,&ind);
		buffer_append_int32(send_buffer,*(int32_t*)&sb_params.gyro_filter.D2,&ind);
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_SET_SELF_BALANCE_PAR:
		sb_params = *self_balancing_get_params();
		ind = 0;
		{
		int32_t val;
		sb_params.loop_period_ms=data[ind++];
		sb_params.n_poles=data[ind++];
		val = buffer_get_int32(data,&ind);
		sb_params.kt 				= *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.r_wheel 			= *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.rho				= *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.d_interwheel    = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.gainsLQR[0]     = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.gainsLQR[1]     = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.gainsLQR[2]     = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.gainsLQR[3]     = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.dot_Xb_filt.N0      = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.dot_Xb_filt.N1      = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.dot_Xb_filt.N2      = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.dot_Xb_filt.D1      = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.dot_Xb_filt.D2      = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.set_Xb_filt.N0  = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.set_Xb_filt.N1  = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.set_Xb_filt.D1  = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.steering_PID.N0 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.steering_PID.N1 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.steering_PID.D1 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.accelero_filter.N0 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.accelero_filter.N1 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.accelero_filter.N2 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.accelero_filter.D1 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.accelero_filter.D2 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.compl_filt_alpha = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.compl_filt_beta = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.gainsLQRsteering[0] = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.gainsLQRsteering[1] = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.imu_accx_offset = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.imu_accz_offset = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.imu_gyro_offset = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.disturbance_torque_ampl = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.disturbance_torque_omega = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.torque_bal_filt.N0 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.torque_bal_filt.N1 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.torque_bal_filt.N2 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.torque_bal_filt.D1 = *(float*) &val;
		val = buffer_get_int32(data,&ind);
		sb_params.torque_bal_filt.D2 = *(float*) &val;
		}

		// persistently save new params
		conf_general_store_self_balancing_params(&sb_params);

		// copy the values of the same filter types
		sb_params.dot_delta_filt.N0=sb_params.dot_Xb_filt.N0;
		sb_params.dot_delta_filt.N1=sb_params.dot_Xb_filt.N1;
		sb_params.dot_delta_filt.N2=sb_params.dot_Xb_filt.N2;
		sb_params.dot_delta_filt.D1=sb_params.dot_Xb_filt.D1;
		sb_params.dot_delta_filt.D2=sb_params.dot_Xb_filt.D2;

		sb_params.ddot_Xb_filt.N0=sb_params.dot_Xb_filt.N0;
		sb_params.ddot_Xb_filt.N1=sb_params.dot_Xb_filt.N1;
		sb_params.ddot_Xb_filt.N2=sb_params.dot_Xb_filt.N2;
		sb_params.ddot_Xb_filt.D1=sb_params.dot_Xb_filt.D1;
		sb_params.ddot_Xb_filt.D2=sb_params.dot_Xb_filt.D2;

		sb_params.gyro_filter.N0=sb_params.accelero_filter.N0;
		sb_params.gyro_filter.N1=sb_params.accelero_filter.N1;
		sb_params.gyro_filter.N2=sb_params.accelero_filter.N2;
		sb_params.gyro_filter.D1=sb_params.accelero_filter.D1;
		sb_params.gyro_filter.D2=sb_params.accelero_filter.D2;

		sb_params.torque_steer_filt.N0=sb_params.torque_bal_filt.N0;
		sb_params.torque_steer_filt.N1=sb_params.torque_bal_filt.N1;
		sb_params.torque_steer_filt.N2=sb_params.torque_bal_filt.N2;
		sb_params.torque_steer_filt.D1=sb_params.torque_bal_filt.D1;
		sb_params.torque_steer_filt.D2=sb_params.torque_bal_filt.D2;

		sb_params.set_delta_filt.N0=sb_params.set_Xb_filt.N0;
		sb_params.set_delta_filt.N1=sb_params.set_Xb_filt.N1;
		sb_params.set_delta_filt.D1=sb_params.set_Xb_filt.D1;

		sb_params.set_dot_Xb_filt.N0=sb_params.set_Xb_filt.N0;
		sb_params.set_dot_Xb_filt.N1=sb_params.set_Xb_filt.N1;
		sb_params.set_dot_Xb_filt.D1=sb_params.set_Xb_filt.D1;

		self_balancing_set_params(&sb_params);
	...
	case COMM_ADD_SETPOINT_LIN_VELOCITY:
		ind = 0;
		seq_dot_Xb = self_balancing_get_sequence_dot_Xb();
		{
			int32_t val1 = buffer_get_int32(data,&ind);
			int32_t val2 = buffer_get_int32(data,&ind);
			reference_add_setpoint(seq_dot_Xb,*(float*)&val1,*(float*)&val2);
		}
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_RESET_SETPOINTS_LIN_VELOCITY:
		ind = 0;
		seq_dot_Xb = self_balancing_get_sequence_dot_Xb();
		reference_reset_sequence(seq_dot_Xb );
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_ADD_SETPOINT_YAW_VELOCITY:
		ind = 0;
		seq_dot_delta = self_balancing_get_sequence_dot_delta();
		{
			int32_t val1 = buffer_get_int32(data,&ind);
			int32_t val2 = buffer_get_int32(data,&ind);
			reference_add_setpoint(seq_dot_delta,*(float*)&val1,*(float*)&val2);
		}
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_RESET_SETPOINTS_YAW_VELOCITY:
		seq_dot_delta = self_balancing_get_sequence_dot_delta();
		reference_reset_sequence(seq_dot_delta);
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_START_SIM_SEQUENCE:
		self_balancing_start_simulation_sequence();
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_START_SEND_IMU:
		self_balancing_enable_send_angle_bluetooth(true);
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
	case COMM_STOP_SEND_IMU:
		self_balancing_enable_send_angle_bluetooth(false);
		ind = 0;
		send_buffer[ind++] = packet_id;
		commands_send_packet(send_buffer, ind);
		break;
