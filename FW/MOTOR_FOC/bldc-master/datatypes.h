...
typedef enum {
	...
	COMM_GET_TACHO,
	COMM_RESET_TACHO,
	COMM_GET_SELF_BALANCE_PAR,
	COMM_SET_SELF_BALANCE_PAR,
	COMM_ADD_SETPOINT_LIN_VELOCITY,
	COMM_RESET_SETPOINTS_LIN_VELOCITY,
	COMM_ADD_SETPOINT_YAW_VELOCITY,
	COMM_RESET_SETPOINTS_YAW_VELOCITY,
	COMM_START_SIM_SEQUENCE,
	COMM_SET_REMOTE_JOYSTICK,
	COMM_START_SEND_IMU,
	COMM_STOP_SEND_IMU
} COMM_PACKET_ID;
...
typedef enum {
	...
	CAN_PACKET_STATUS,
	CAN_PACKET_GET_TACHO,
	CAN_PACKET_GET_TACHO_ANSW,
	CAN_PACKET_RESET_TACHO,
	CAN_PACKET_BLUETOOTH_PROCESS_RX_BUFFER,
	CAN_PACKET_BLUETOOTH_PROCESS_SHORT_BUFFER,
} CAN_PACKET_ID;
